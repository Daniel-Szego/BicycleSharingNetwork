...
describe('RepairedComponent', () => {
  ...
  let mockRepairedService;
  let mockDataService

  beforeEach(async(() => {

    mockRepairedService = sinon.createStubInstance(RepairedService);
    mockRepairedService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: RepairedService, useValue: mockRepairedService },
