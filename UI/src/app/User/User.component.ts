...
export class UserComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.bicyclesharing.model.User',
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceUser.updateParticipant(form.get('ActorID').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.UserAddress) {
        formObject.UserAddress = result.UserAddress;
      } else {
        formObject.UserAddress = null;
      }
