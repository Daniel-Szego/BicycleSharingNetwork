...
@Component({
  selector: 'app-bycicle',
  templateUrl: './Bycicle.component.html',
  styleUrls: ['./Bycicle.component.css'],
  providers: [BycicleService]
})
export class BycicleComponent implements OnInit {
  ...
  BicycleWheel = new FormControl('', Validators.required);
  ...
  constructor(public serviceBycicle: BycicleService, fb: FormBuilder) {
    this.myForm = fb.group({
      BicycleWheel: this.BicycleWheel,
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceBycicle.getAll()
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.bicyclesharing.model.Bycicle',
      'BicycleWheel': this.BicycleWheel.value,
    ...
    return this.serviceBycicle.addAsset(this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceBycicle.updateAsset(form.get('ObjectID').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceBycicle.deleteAsset(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceBycicle.getAsset(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
      ...
      if (result.BicycleWheel) {
        formObject.BicycleWheel = result.BicycleWheel;
      } else {
        formObject.BicycleWheel = null;
      }
