...
const routes: Routes = [
  ...
  { path: 'Bycicle', component: BycicleComponent },
  { path: 'Bike', component: BikeComponent },
  { path: 'User', component: UserComponent },
  { path: 'AssetOwner', component: AssetOwnerComponent },
  { path: 'InitTestData', component: InitTestDataComponent },
  { path: 'ClearData', component: ClearDataComponent },
  { path: 'HireBycicle', component: HireBycicleComponent },
  { path: 'NeedRepair', component: NeedRepairComponent },
  { path: 'Repaired', component: RepairedComponent },
  { path: '**', redirectTo: '' }
];
